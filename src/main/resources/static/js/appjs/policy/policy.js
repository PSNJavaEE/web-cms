                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter : function(value, row, index) {
                            if (value == '1') {
                                return '<span class="label label-danger">科技政策</span>';
                            } else if(value == '2'){
                                return '<span class="label label-primary">试点政策</span>';
                            }
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        formatter : function(value, row, index) {
                            if (value == 0 ) {
                                return '<span class="label label-danger">未推荐</span>';
                            } else{
