...
import com.forwork.cms.common.domain.ColumnDO;
import com.forwork.cms.common.domain.TableDO;
...
//		}
        ...
        if (template.contains("Controller.java.vm")) {
            return packagePath + "ScientistDetailController" + File.separator + className + "Controller.java";
        }
